...
class ModelCatalogCategory extends Model {
	...
	public function editCategory($category_id, $data) {
		...
		foreach ($data['category_description'] as $language_id => $value) {
			...
			$this->db->query("INSERT INTO " . DB_PREFIX . "category_description SET category_id = '" . (int)$category_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', description = '" . $this->db->escape($value['description']) . "', long_description = '" . $this->db->escape($value['long_description']) . "', meta_title = '" . $this->db->escape($value['meta_title']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "'");
	...
	public function getCategories($data = array()) {
		...
		if (!empty($data['filter_category_id'])) {
			$sql .= " AND cp.category_id = '" . $this->db->escape($data['filter_category_id']) . "'";
		}
