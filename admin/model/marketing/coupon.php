...
class ModelMarketingCoupon extends Model {
	public function addCoupon($data) {
		...
		if (isset($data['coupon_ex_product'])) {
			foreach ($data['coupon_ex_product'] as $product_id) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "coupon_ex_product SET coupon_id = '" . (int)$coupon_id . "', product_id = '" . (int)$product_id . "'");
			}
		}
		...
		if (isset($data['coupon_ex_category'])) {
			foreach ($data['coupon_ex_category'] as $category_id) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "coupon_ex_category SET coupon_id = '" . (int)$coupon_id . "', category_id = '" . (int)$category_id . "'");
			}
		}
	...
	public function editCoupon($coupon_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "coupon_ex_product WHERE coupon_id = '" . (int)$coupon_id . "'");
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "coupon_ex_category WHERE coupon_id = '" . (int)$coupon_id . "'");
	...
	public function getCouponExProducts($coupon_id) {
		$coupon_product_data = array();

		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "coupon_ex_product WHERE coupon_id = '" . (int)$coupon_id . "'");
	...
	public function getCouponExCategories($coupon_id) {
		$coupon_category_data = array();

		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "coupon_ex_category WHERE coupon_id = '" . (int)$coupon_id . "'");
