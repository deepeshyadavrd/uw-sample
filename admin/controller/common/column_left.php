...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/upload_img')) {
				$catalog[] = array(
					'name'	   => 'Upload Custom Images',
					'href'     => $this->url->link('catalog/upload_img', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'design/home_section')) {
				$design[] = array(
					'name'	   => 'Homepage Sections',
					'href'     => $this->url->link('design/home_section', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'sale/new_order')) {
				$sale[] = array(
					'name'	   => 'New Order',
					'href'     => $this->url->link('sale/new_order', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			...
			if ($this->user->hasPermission('access', 'marketing/campaign')) {
				$marketing[] = array(
					'name'	   => 'Campaign',
					'href'     => $this->url->link('marketing/campaign', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
