...
$category_total = 1;
	...
	protected function getForm() {
		...
		if($category_info['custom_filter']!=''){
			$custom_filter_ids = explode(',', $category_info['custom_filter']);
			foreach ($custom_filter_ids as $custom_filter_id) {
				$cat_info = $this->model_catalog_category->getCategory($custom_filter_id);
		...
		// print_r($data['custom_filter']);exit;
