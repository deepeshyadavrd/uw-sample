...
class ControllerCatalogCollection extends Controller {
	...
	public function index() {
		...
		$this->document->setTitle('Collection');
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_collection->addCategory($this->request->post);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_collection->editCategory($this->request->get['category_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $category_id) {
				$this->model_catalog_collection->deleteCategory($category_id);
			}
	...
	public function repair() {
		...
		if ($this->validateRepair()) {
			$this->model_catalog_collection->repairCategories();
	...
	protected function getList() {
		...
		$category_total = $this->model_catalog_collection->getTotalCategories();
	...
	protected function getForm() {
		...
		if (isset($this->request->get['category_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$category_info = $this->model_catalog_collection->getCategory($this->request->get['category_id']);
		}
		...
		if (isset($this->request->post['category_description'])) {
			...
			$data['category_description'] = $this->model_catalog_collection->getCategoryDescriptions($this->request->get['category_id']);
		} else {
		...
		if (isset($this->request->post['category_filter'])) {
			...
			$filters = $this->model_catalog_collection->getCategoryFilters($this->request->get['category_id']);
		} else {
			$filters = array();
		}
		...
		if (isset($this->request->post['category_store'])) {
			...
			$data['category_store'] = $this->model_catalog_collection->getCategoryStores($this->request->get['category_id']);
		} else {
		...
		if (isset($this->request->post['category_seo_url'])) {
			...
			$data['category_seo_url'] = $this->model_catalog_collection->getCategorySeoUrls($this->request->get['category_id']);
		} else {
		...
		if (isset($this->request->post['category_layout'])) {
			...
			$data['category_layout'] = $this->model_catalog_collection->getCategoryLayouts($this->request->get['category_id']);
		} else {
	...
	protected function validateForm() {
		...
		if (isset($this->request->get['category_id']) && $this->request->post['parent_id']) {
			$results = $this->model_catalog_collection->getCategoryPath($this->request->post['parent_id']);
