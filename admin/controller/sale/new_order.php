<?php
class ControllerSaleNewOrder extends Controller {
	private $error = array();
	...
	protected function getList() {
		...
		$data['add'] = $this->url->link('sale/new_order/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$this->response->setOutput($this->load->view('sale/new_order_list', $data));
	}
	...
	public function getForm() {
		...
		$this->response->setOutput($this->load->view('sale/new_order_form', $data));
	}
