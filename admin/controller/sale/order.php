		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				if ($order_info['payment_address_format']) {
					...
					$format = '<p class="client-name">{firstname} {lastname}</p> <p class="text-muted mb-1">{address_1}' . "\n" . '{address_2}' . "\n" . '{city} {postcode}</p><p class="text-muted mb-1"><span style="font-weight: bold;text-align: left;">State</span>:{zone}</p>';
				}
