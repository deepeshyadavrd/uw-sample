...
class ModelCheckoutOrder extends Model {
	...
	public function addTxnResponse($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "transaction_response SET order_id = '" . (int)$data['order_id'] . "', tracking_id = '" . $this->db->escape($data['tracking_id']) . "', bank_ref_no = '" . $this->db->escape($data['bank_ref_no']) . "', order_status = '" . $this->db->escape($data['order_status']) . "', failure_message = '" . $this->db->escape($data['failure_message']) . "', payment_mode = '" . $this->db->escape($data['payment_mode']) . "', card_name = '" . $this->db->escape($data['card_name']) . "', status_code = '" . $this->db->escape($data['status_code']) . "', status_message = '" . $data['status_message'] . "', amount = '" . (int)$data['amount'] . "', currency = '" . $this->db->escape($data['currency']) . "',date_added = NOW()");
