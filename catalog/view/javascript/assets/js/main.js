...
//     });
    ...
    //   $('.bbb_next0').click(function() {
    //     // event.preventDefault();
    //     //  $(this).closest('bbb_slider_nav').find(".bbb_slider").children('.owl-nav').children('.owl-next').trigger("click");
    //     $(this).trigger('next.owl.carousel');
    //     //  console.log($(this).closest('.bbb_slider_container').find('.owl-carousel').trigger('.owl-next'));
    // });
    
    // $('.bbb_prev0').click(function() {
    //     // event.preventDefault();
...
//     ndicator.style.setProperty("--position", index)
