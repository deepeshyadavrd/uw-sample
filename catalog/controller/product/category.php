...
//print_r($data['products']);
			...
			// 	'href'  => '?route=product/category&path='.$this->request->get['path'].'&sort=p.sort_order&order=ASC' . $url//$this->url->link('product/category', 'path=' . $this->request->get['path'] . '&sort=p.sort_order&order=ASC' . $url)
			// );
			...
			// 	'value' => 'p.price-ASC',
			// 	'href'  => '?route=product/category&path='.$this->request->get['path'].'&sort=p.price&order=ASC' . $url //$this->url->link('product/category', 'path=' . $this->request->get['path'] . '&sort=p.price&order=ASC' . $url)
			// );
	...
	public function loop_again($num, $url) {
		...
		if (isset($num)) {
			...
			$data['breadcrumbs'] = array(
						'text' => $cat_info['name'],
						'href' => $this->url->link('product/category', 'path=' . $num. $url )
					);
