<?php
class ControllerProductCategory11 extends Controller {
	public function index() {
		...
		if ($category_info) {
			...
			foreach ($results as $result) {
				if ($result['image']) {
					$image = $this->model_tool_image->resize($result['image'], 604, 417);
				} else {
					$image = $this->model_tool_image->resize('placeholder.png',604, 417);
				}
