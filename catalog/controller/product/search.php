...
foreach ($results as $product) {
    ...
    $firstWord = explode(" ", $product['name'])[0];

    // Use the first word and price as a unique key
    $key = strtolower($firstWord) . '-' . $product['price'];

    // If this key hasn't been added, add to uniqueProducts
...
// $uniqueProducts now contains only unique products based on the first word and price
// print_r($uniqueProducts);

			foreach ($uniqueProducts as $result) {
