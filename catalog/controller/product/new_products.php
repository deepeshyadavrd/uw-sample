...
class ControllerProductNewProducts extends Controller {
    public function index() {
        ...
        foreach ($results as $result) {
            ...
            if ($result['image2']) {
                $image2 = $this->model_tool_image->resize($result['image2'], 400, 281);
            } else {
                $image2 = $this->model_tool_image->resize('placeholder.png', $this->config->get('theme_' . $this->config->get('config_theme') . '_image_product_width'), $this->config->get('theme_' . $this->config->get('config_theme') . '_image_product_height'));
            }
