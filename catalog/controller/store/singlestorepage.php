     ...
     public function index(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			if($_POST['name'] != ' ' && $_POST['name'] != NULL && $_POST['email'] != ' ' && $_POST['email'] != NULL){
				...
				$result = $this->model_information_requestcallback->addCatalogrequest($this->request->post);
			$to="urbanwoodindia.in@gmail.com";
			$subject="Furniture in ". $_POST['storecity'] ." enquiry";
	   ...
	   " boundary=\"{$mime_boundary}\"";
		 ...
		 if(isset($_POST["time_slot"]) || isset($_POST["date"])){
			 ...
			 $message="Enquiry For Furniture (Catalog Request)\n\n";
...
// 				$storecity = strtok($location_info['name'], " ");
