...
// print_r($products[0]);
			// foreach ($products as $product) {
				...
				$options = $this->model_account_order->getOrderOptions($result['order_id'], $products[0]['order_product_id']);
				...
				if ($product_info) {
					$reorder = $this->url->link('account/order/reorder', 'order_id=' . $result['order_id'] . '&order_product_id=' . $products[0]['order_product_id'], true);
				} else {
					$reorder = '';
				}
				$this->load->model('tool/image');
				if ($product_info['image']) {
					$image = $this->model_tool_image->resize($product_info['image'], 323, 223);
				} else {
