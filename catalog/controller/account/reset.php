...
// print_r($this->request->post['password']);
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
				...
				$this->response->redirect('login');//$this->url->link('account/login', '', true));
			...
			$data['action'] = '?route=account/reset&code='. $code;//$this->url->link('account/reset', 'code=' . $code, true);
